...
| Region/profile composition | T23, T25, T27 | `apps/world` + shared world profile seam `VERIFY` | environment/profile data | Babylon atmosphere + audio | provisional | `docs/design/world/REGIONS-AND-ATMOSPHERE.md` |
...
| Boulevard world slice | T21, T23 | `apps/world` | locations/profile/World save data | Babylon world + Tone.js | active; narrative slice incomplete | `docs/design/locations/DISSONANCE-BOULEVARD.md` |
