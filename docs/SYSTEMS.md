...
| Ambiguity & Placement narrative engine | T40 | `apps/world/src/narrative` (pure reducer, `TBD`) + `apps/world/src/lore` (Dissonance data, `TBD`) | `NarrativeState` (conditions only — no stored conclusions, per G3) | terminal surface (T29, gated on O33) + logged intents elsewhere | design reconciled 2026-08-06; no code yet; gated on O28–O32 | `docs/intake/pattern-ambiguity-and-placement-v1.md`, `docs/intake/eng-ambiguity-placement-v1.md` |
