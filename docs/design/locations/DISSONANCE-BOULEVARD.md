# Dissonance Boulevard

**Status:** active  
**Owning thread:** T21 / T23, with T10 narrative authority  
**Canonical scope:** Boulevard spatial spine, coverage geography, authored encounters, and continuous-slice composition  
**Does not own:** Generic Lineglass, global region composition, or sound-control implementation  
**Runtime owner:** `apps/world`  
**State owner:** locations/profile data + World save discovery state  
**Presentation owner:** Babylon world, Tone.js, Lineglass  
**Depends on:** T21 world substrate, T23 regions, T25/T27 atmosphere, T29 terminal, T9 where sound control is consumed  
**Consumed by:** T13 reference extraction, Milo's apartment, T31 acquisition  
**Decisions:** D41, D44, D45  
**Open questions:** O4, O9  
