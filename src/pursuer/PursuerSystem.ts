...
export class PursuerSystem {
  ...
  update(
    ...
    // Crouching reduces detection envelope
    const detectionScale = isCrouching ? 0.55 : 1.0;

    // Pursuer moves slower when it can't see the player
